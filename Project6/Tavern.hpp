...
class Tavern : public ArrayBag<Character*>{
  public:
    ...
    */
    static bool levelIsLess(const Character* lhs, const Character* rhs);
    ...
    */
    static bool levelIsGreater(const Character* lhs, const Character* rhs);
    ...
    */
    static bool vitalityIsLess(const Character* lhs, const Character* rhs);
    ...
    */
    static bool vitalityIsGreater(const Character* lhs, const Character* rhs);
    ...
    */
    ...
    /**
    Shows the details of each character in the combar queue
  ...
  private:
    ...
    Character* main_character;  //A pointer to a main character
    std::queue<Character*> combat_queue; //A combat queue of Character pointers, enemies that the main character must fight.
    ...
    */
    std::string actionToString(int num);
