...
class Character
{
    public:
        ...
        */
        ...
        /**
        A pure virtual function to support polymorphism, subclasses will inherit the function 
        and contain implementation. 
        @post: Displays the characters details such as name, race, vitality, etc (the exact
        modifications will be subclass specific)
        **/
        virtual void display() const = 0;

        /**
        A pure virtual function to support polymorphism that modifies the characters private member variables,
        subclasses will inherit the function and contain implementation
