...
CSCI335 Spring 2023
Project 2 
Original Owner: Data Structures and Algorithms Anaylsis in C++ 4th EditionMark Allen Weiss
Julianne Aguilar
April 10, 2024
myAVLtree.hpp defines the functions treeMedian and returnableTree, declares and defines the functions and members 
of the AvlTree class, modifcations to original code in AvlTree class were made to allow for duplicates and to return 
size of AVL tree.
  ...
  private:
    ...
    void insert( const Comparable & x, AvlNode * & t )
    {
        if( t == nullptr )
            ...
            insert( x, t->left );
        else if( t->element <= x ) //Personal mod: allows for duplicates, sets duplicate as right child
            insert( x, t->right );
